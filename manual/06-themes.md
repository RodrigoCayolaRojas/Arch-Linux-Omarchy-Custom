...
Each theme styles the desktop, terminal, neovim, activity screen (btop), and the entire Omarchy shell: top bar, menu, notifications, OSD, and the lock screen. A browser you install from the Omarchy menu gets themed to match too.
